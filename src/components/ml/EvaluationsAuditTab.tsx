                    ...
                    onClick={() =>
                      onInspectItem({
                        ...
                        whatWeKnow: [
                          ...
                          { label: 'Veto Threshold', value: ev.veto_threshold != null ? Number(ev.veto_threshold).toFixed(2) : '—' },
                          { label: 'Favorable Threshold', value: ev.favorable_threshold != null ? Number(ev.favorable_threshold).toFixed(2) : '—' },
                        ],

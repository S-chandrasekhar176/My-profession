...
# Hindu BusinessLine RSS (verified fresh, 60+ items, updates every ~30 mins)
_HBL_RSS_URL = "https://www.thehindubusinessline.com/markets/feeder/default.rss"
...
class HinduBusinessLineSource:
    """Fetch news from The Hindu BusinessLine RSS feed.

    Replaces dead Business Standard RSS. Uses feedparser to parse RSS
    and extracts F&O stock names from headlines.
    """

    def __init__(self, timeout: float = 15.0):
        self.timeout = timeout
        self.rss_url = _HBL_RSS_URL
    ...
    async def fetch(self) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            logger.error("Failed to fetch Hindu BusinessLine RSS: %s", e)

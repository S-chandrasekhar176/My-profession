...
# NDTV Profit RSS (verified fresh, 20+ items, updates every ~15 mins)
_NDTV_RSS_URL = "https://feeds.feedburner.com/ndtvprofit-latest"
...
class NDTVProfitSource:
    """Fetch news from NDTV Profit RSS feed.

    Replaces dead Moneycontrol RSS. Uses feedparser to parse RSS
    and extracts F&O stock names from headlines.
    """

    def __init__(self, timeout: float = 15.0):
        self.timeout = timeout
        self.rss_url = _NDTV_RSS_URL
    ...
    async def fetch(self) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            logger.error("Failed to fetch NDTV Profit RSS: %s", e)
